...
public class DirectiveUtils {
    ...
    /**
     * Returns an unmarshaller that will read a JSON request into a T:
     */
    public static <T> Unmarshaller<HttpEntity, T> fromJSON(Class<T> t) {
        return Jackson.<T>unmarshaller(t);
    }
    
    /**
     * Protobuf accepted MimeTypes
     */
    public static HashSet<MediaType> protoMediaTypes = HashSet.of(
            MediaTypes.APPLICATION_GRPC_PROTO,
            MediaTypes.customBinary("application", "x-protobuf", false), 
            MediaTypes.customBinary("application", "vnd.google.protobuf", false),
            MediaTypes.customBinary("application", "protobuf", false)
    );
